...
// Make 1st API call to search Calls
  axios.post('https://api.hubapi.com/crm/v3/objects/calls/search', callData, params 
            ).then(response => {
            ...
            axios.post('https://api.hubapi.com/crm/v3/objects/emails/search', emailData, params 
                      ).then(res => {
